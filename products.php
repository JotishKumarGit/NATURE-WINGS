...
<head>
    <meta charset="utf-8">
    <title>NATURE WINGS - Products </title>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-3 mb-3">
                    <div class="card h-100 shadow-sm">
                        <img src="img/Pure-Himalayan-Shilajit.jpeg" class="card-img-top" style="height: 260px"
                            alt="Himalayan" />
                ...
                <div class="col-md-3 mb-3">
                    <div class="card h-100 shadow-sm">
                        <img src="img/Pure-kashmiri-saffron.jpeg" style="height: 260px" class="card-img-top"
                            alt="Kashmiri" />
                        <div class="card-body text-center">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card h-100 shadow-sm">
                        <img src="img/Laveadus-Essential-Oil.jpeg" style="height: 260px" class="card-img-top"
                            alt="MONGRA" />
                        <div class="card-body text-center">
                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#enquiryModal">Enquiry</a>
                                <a href="Himachal-pardesh-quality-Cordyceps-sinesis(4000grade).php"
