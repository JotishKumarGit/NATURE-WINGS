...
<head>
    <meta charset="utf-8">
    <title>NATURE WINGS - Wild garlic (Fritillaria) </title>
    ...
    <div class="container product-container">
        <div class="row product-box p-4 animate__animated animate__fadeInUp">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <img src="img/lahsun.jpeg" alt="Wild Garlic (Fritillaria)"
            ...
            <div class="col-md-6 product-details mt-4 mt-md-0 animate__animated animate__fadeInRight">
                ...
                <p>
                    Wild Garlic, also known as <strong>Fritillaria</strong>, is a powerful herb traditionally used in
                    Himalayan medicine. Known for its natural detoxifying and antimicrobial properties, it helps support
                    respiratory health and immune function. A rare and potent ingredient, Wild Garlic is highly valued
                    in
                ...
                <ul class="feature-list">
                    ...
                    <li>🛡️ Boosts natural immunity</li>
                    <li>🧄 Acts as a natural detoxifier</li>
                    <li>🌬️ Helps clear congestion and phlegm</li>
                    <li>✅ Wild harvested and chemical-free</li>
                </ul>
